  ...
  return (
    <div className="container py-10">
      <div className="mx-auto max-w-3xl prose prose-slate prose-sm">
        ...
        <p>
          CV Hi Bali Nusa Tenggara (&quot;Gilifast&quot;, &quot;we&quot;) is committed to protecting
        ...
        <ul>
          ...
          <li><strong>Payment data:</strong> Method (QRIS, e-wallet, etc.), amount, timestamp. Card numbers and PINs are handled by Midtrans; we never see them.</li>
        ...
        <ul>
          ...
          <li><strong>Midtrans (payment gateway):</strong> Payment details so the transaction can be processed.</li>
        ...
        <p>
          ...
          Midtrans, and we log every administrative action. Despite this, no
        ...
        <p>
          Gilifast is not intended for users under 18. Minors travel under the
