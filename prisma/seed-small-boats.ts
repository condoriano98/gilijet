...
const OPERATORS: SeedOperator[] = [
  ...
  {
    key: "bluewater",
    email: "bluewater@gilifast.local",
  ...
  {
    key: "marina-srikandi",
    email: "marina-srikandi@gilifast.local",
